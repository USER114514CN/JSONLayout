...
public class Test {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String json = """
        {
            "rootLayout": {
                ...
                "layout": {
                    ...
                    "target": {
                        "class": "CONST",
                        "name": "com.user114514.jsonlayout.core.Test.windowFrame"
                    },
                    "axis": {
                        "class": "CONST",
                        "name": "javax.swing.BoxLayout.Y_AXIS"
                    }
                },
                "contents": [
                    {
                        ...
                        "contents": [
                            {
                                ...
                                "text":  {
                                    "class": "CONST",
                                    "name": "com.user114514.jsonlayout.core.TestConstants.EXAMPLE_TEXT"
                                }
                            },
                            {
        ...
        // Button 没有 setText 方法，Label 也没有 setText 方法，居然把这个细节忘了，哭死了😭😭😭 (后续证明不是的)
        ...
        // OS: 有点肉麻了吧...
        // 咳咳，不过Java AWT字体这一块拉完了，连中文都显示不了，我他妈还不能手动setFont，你也知道的Font就那几个预设("Dialog", "Serif", "SansSerif", "Monospaced")，都不支持中文，createFont使用TTF文件还他妈渲染不了😭😭😭
        // 我写这么一大堆注释感觉是疯了……
        // 哈哈哈哈哈哈哈哈哈哈
        // 哈你妈，哈哈就能解决问题吗，我真是个大傻子，哈哈哈哈哈😭😭😭
        ...
        // ……
        // 豆包你个傻子，Panel的setBackground方法需要一个Color对象，而不是一个字符串，你还想让我怎么处理这个属性啊，你这是在干嘛吗？我已急哭🤗🤗🤗🤗
        ...
        // 哦哦哦哦哦哦哦哦哦哦哦哦哦哦哦哦哦哦哦哦哦哦哦哦哦哦哦哦哦哦哦哦哦哦哦哦哦哦哦哦哦哦噢噢噢噢
    }
}
